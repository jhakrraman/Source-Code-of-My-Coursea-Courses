...
Desired Output : Yellow is the color of sunshine
...
there would be 26 possibilities.  For a 2 letter password, each letter is independent of the other, so there would be 26 times 26 possibilities.  
Using this information, print the amount of possible passwords that can be formed with 6 letters.

letter = 26 ** 6
print(letter)

Desired Output : 308915776
